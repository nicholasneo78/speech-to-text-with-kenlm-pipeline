...
dataset_finetuned = Dataset.get(dataset_id=arg.dataset_finetuned_task_id)
dataset_finetuned_path = dataset_finetuned.get_local_copy()

# obtaining the kenlm lm
lm = Dataset.get(dataset_id=arg.lm_id)
lm_path = lm.get_local_copy()

evaluation = EvaluationWithLM(finetuned_model_path=f'{dataset_finetuned_path}/{arg.finetuned_model_path}',
                              processor_path=f'{dataset_finetuned_path}/{arg.input_processor_path}',
                              lm_path=f'{lm_path}/{arg.lm_path}', 
                              test_data_path=f'{dataset_pkl_path}/{arg.test_pkl}', 
